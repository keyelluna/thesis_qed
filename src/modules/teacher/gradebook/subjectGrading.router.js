...
router.get(
  ...
  controller.getSubjectSectionInfo,
);

router.get(
  "/:subjectSectionId/items",
  verifyToken,
  controller.loadSubjectSection,
  controller.getItems,
);
...
router.get(
  ...
  verifyToken,
  controller.loadSubjectSection,
  controller.getHolistic,
);
router.put(
  "/:subjectSectionId/holistic",
  verifyToken,
  controller.loadSubjectSection,
  controller.upsertHolistic,
);

router.get(
  "/:subjectSectionId/topics",
  verifyToken,
  controller.loadSubjectSection,
...
router.get(
  "/:subjectSectionId/interventions",
  verifyToken,
  controller.loadSubjectSection,
  topicController.getInterventions,
);
router.post(
  "/:subjectSectionId/interventions",
  verifyToken,
  controller.loadSubjectSection,
  topicController.createIntervention,
);
router.put(
